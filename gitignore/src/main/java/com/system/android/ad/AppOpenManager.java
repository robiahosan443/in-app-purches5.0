...
import me.araib.module.ad.BuildConfig;
...
public class AppOpenManager implements Application.ActivityLifecycleCallbacks, LifecycleObserver {
    ...
    public AppOpenManager(Application myApplication, String openAdId) {
...
//            AdsManager.setdefaluts(currentActivity);
            AdRequest request = getAdRequest();


            if (!BuildConfig.DEBUG) {
                AppOpenAd.load(
                        myApplication, openAdId, request,
