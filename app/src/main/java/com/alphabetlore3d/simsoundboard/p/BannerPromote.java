...
import com.alphabetlore3d.simsoundboard.p.Helper.PromotePrefs;
...
public class BannerPromote extends FrameLayout {
    ...
    private ArrayList<com.alphabetlore3d.simsoundboard.p.Models.AppModels> adListBanner = new ArrayList<>();
    ...
    private void inflateBanner() {
        ...
        inflater.inflate(R.layout.pr_ba, this);
    }

    private void initializeData() {
        promotePrefs = new PromotePrefs(context);
        DatabaseHelper databaseHelper = new DatabaseHelper(context);
        adListBanner = databaseHelper.getAllBannerApps();
    }
    ...
    public void showPromoteBanner() {
        ...
        try {
            ...
            if (adListBanner != null && !adListBanner.isEmpty()) {
                int size = adListBanner.size();
    ...
    private void buildBanner(int index) {
        ...
        initializeInflateUI();
        String data_name = adListBanner.get(index).getName();
        String data_icons = adListBanner.get(index).getIcons();
        String short_description = adListBanner.get(index).getShortDescription();
        String data_packageName = adListBanner.get(index).getPackageName();
        ...
        installButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AppsConfig.openAdLink(context, data_packageName, data_name);
            }
        });
